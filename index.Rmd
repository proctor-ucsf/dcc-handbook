...
link-citations: yes
description: "This is a handbook to help summarize best practices in data science among team members at the Francis I. Proctor Foundation. The output format for this example is bookdown::gitbook."
---
...
We do not intend this handbook to be a comprehensive guide to data science. Instead, it focuses more on practical, "how-to" guidance for conducting data science within epidemiologic research studies.  Although many of the ideas of environment-independent, the examples draw from the [R](https://cran.r-project.org/) programming language. For an excellent overview of data science in R, see the book [R for Data Science](https://r4ds.had.co.nz/).
